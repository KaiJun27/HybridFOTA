...
C_SRCS += \
../myIncludes/liboqs/src/sig/sig.c 

OBJS += \
./myIncludes/liboqs/src/sig/sig.o 

C_DEPS += \
./myIncludes/liboqs/src/sig/sig.d 


# Each subdirectory must supply rules for building sources it contributes
myIncludes/liboqs/src/sig/%.o myIncludes/liboqs/src/sig/%.su myIncludes/liboqs/src/sig/%.cyclo: ../myIncludes/liboqs/src/sig/%.c myIncludes/liboqs/src/sig/subdir.mk
...
clean: clean-myIncludes-2f-liboqs-2f-src-2f-sig

clean-myIncludes-2f-liboqs-2f-src-2f-sig:
	-$(RM) ./myIncludes/liboqs/src/sig/sig.cyclo ./myIncludes/liboqs/src/sig/sig.d ./myIncludes/liboqs/src/sig/sig.o ./myIncludes/liboqs/src/sig/sig.su

.PHONY: clean-myIncludes-2f-liboqs-2f-src-2f-sig
